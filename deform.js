...
function drawObjects(){
  ...
  scene.add(group[0], group[1], group[2]);
}
...
function render(){
  ...
  group[0].rotation.z += degToRad(0.3);

  group[1].rotation.x += degToRad(-0.3);
  group[1].rotation.y += degToRad(-0.1);
  group[1].rotation.z += degToRad(-0.3);

  group[2].rotation.x += degToRad(-0.1);
  group[2].rotation.y += degToRad(0.1);
  group[2].rotation.z += degToRad(-0.3);
